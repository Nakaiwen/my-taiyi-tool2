        ...
        let html = `
            ...
            <head>
                ...
                <style>
                    ...
                    .term-text { color: #2e7d32; font-weight: bold; }
        ...
        results.forEach(r => {
            html += `
                <tr>
                    ...
                    <td class="pattern-text">${r.tianGang}</td>
                    <td class="pattern-text">${r.deRuTianMenRi}</td>
                    <td class="pattern-text">${r.deRuTianMenZhi}</td>
                    <td class="special-text">${r.specialDay}</td>
                </tr>
            `;
        });
